        ...
        <div className="md:w-[60%] w-full px-[4vw] z-[10]">
          ...
          <div className="flex">
            <a
              ...
              className="md:text-2xl text-[4vw] font-semibold rounded-full mt-[2vw] py-2 md:px-[5vw] px-[6vw] whitespace-nowrap bg-[#E50112]"
            >
              Watch Trailer
            </a>
            <button className="md:text-2xl font-semibold rounded-full mt-[2vw] py-2 md:px-[5vw] px-[6vw] border-2 mx-3">
              Add to watch list
            </button>
          </div>
        </div>
